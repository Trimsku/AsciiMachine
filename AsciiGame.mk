...
OBJS := $(OBJS_DIR)/main.o $(OBJS_DIR)/Player.o $(OBJS_DIR)/GameApp.o $(OBJS_DIR)/MainMenuRenderer.o 
...
$(OBJS_DIR)/MainMenuRenderer.o: testGame/scene/MainMenuRenderer.cpp
	$(SILENT) echo Building $@...
	$(SILENT) $(CXX)  $(CFLAGS) -c $< -o $@ $(ARGS) -MMD -MP -MF $(OBJS_DIR)/MainMenuRenderer.d
