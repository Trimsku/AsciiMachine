...
int main() {
    ...
    EvilEntity.isFontLoaded("../Example2/font/10894.otf");
    EvilEntity.newSprites("../Example2/EvilEntity.rtxt", "e_entity");
    ...
    while (window.isOpen())
    {
        ...
        if(sf::Keyboard::isKeyPressed(sf::Keyboard::Right)){
            GUI_O_ANIMATED_MV(Player, PlayerStand, 0.3f, 0);
        }
