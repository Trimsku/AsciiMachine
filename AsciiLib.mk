...
$(OBJS_DIR)/Entity.o: src/common/entity/Entity.cpp
	$(SILENT) echo Building $@...
	$(SILENT) $(CXX) -fPIC $(CFLAGS) -c $< -o $@ $(ARGS) -MMD -MP -MF $(OBJS_DIR)/Entity.d

$(OBJS_DIR)/Scene.o: src/common/Scene.cpp
	$(SILENT) echo Building $@...
	$(SILENT) $(CXX) -fPIC $(CFLAGS) -c $< -o $@ $(ARGS) -MMD -MP -MF $(OBJS_DIR)/Scene.d

$(OBJS_DIR)/Object.o: src/common/event/Object.cpp
	$(SILENT) echo Building $@...
	$(SILENT) $(CXX) -fPIC $(CFLAGS) -c $< -o $@ $(ARGS) -MMD -MP -MF $(OBJS_DIR)/Object.d
